...
public class CouponMetaData implements Parcelable {
    ...
    @Expose
    private CouponMetaDataValue value;
    ...
    public CouponMetaDataValue getValue() {
        return value;
    }
    
    public void setValue(CouponMetaDataValue value) {
        this.value = value;
    }
    ...
    public void writeToParcel(Parcel parcel_out, int flags) {
        ...
        parcel_out.writeParcelable(value, flags);
    }
    ...
    protected CouponMetaData(Parcel parcel_in) {
        ...
        this.value = parcel_in.readParcelable(CouponMetaDataValue.class.getClassLoader());
    }
