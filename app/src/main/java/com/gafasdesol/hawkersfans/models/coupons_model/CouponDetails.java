package com.gafasdesol.hawkersfans.models.coupons_model;
...
import com.gafasdesol.hawkersfans.models.links_model.Links;
...
public class CouponDetails implements Parcelable {
    ...
    @Expose
    private List<CouponMetaData> meta_data = new ArrayList<>();
    ...
    public List<CouponMetaData> getMeta_data() {
        return meta_data;
    }
    
    public void setMeta_data(List<CouponMetaData> meta_data) {
    ...
    public void writeToParcel(Parcel parcel_out, int flags) {
        ...
        parcel_out.writeList(meta_data);
    ...
    protected CouponDetails(Parcel parcel_in) {
        ...
        parcel_in.readList(meta_data, CouponMetaData.class.getClassLoader());
